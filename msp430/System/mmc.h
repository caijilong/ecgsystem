...
static unsigned char sd_buffer[512]={0};
// macro defines
...
//#define CS_HIGH()   SPI_TX_DONE; P3OUT |= SD_CS  // Card Deselect
#define CS_HIGH()   P3OUT |= SD_CS  // Card Deselect
...
char mmcSetBlockLength (const unsigned int);

// read a size Byte big block beginning at the address.
//char mmcReadBlock(const unsigned long address, const unsigned long count, unsigned char *pBuffer);
//#define mmcReadSector(sector, pBuffer) mmcReadBlock(sector*512, 512, pBuffer)
